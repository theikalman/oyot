...
| #                                                                  | Title                                                                                | Status                                                                           |
| ------------------------------------------------------------------ | ------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------- |
| [0001](0001-mqtt-over-iroh-for-signaling.md)                       | Use MQTT over Iroh's public relay for WebRTC signaling                               | Superseded by [0022](0022-drop-the-broker-and-sync-only-on-the-local-network.md) |
